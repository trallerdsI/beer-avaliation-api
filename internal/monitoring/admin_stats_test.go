...
func TestGetAdminStatsSuccess(t *testing.T) {
	...
	c := NewMonitoringController(&fakeBeerRepo{stats: stats}, &fakeUserRepo{}, nil, nil, nil, nil)
...
func TestGetAdminStatsRepoError(t *testing.T) {
	c := NewMonitoringController(&fakeBeerRepo{err: errors.ErrDatabaseUnavailable}, &fakeUserRepo{}, nil, nil, nil, nil)
...
func TestGetUserStatsSuccess(t *testing.T) {
	...
	c := NewMonitoringController(beerRepo, userRepo, nil, nil, nil, nil)
