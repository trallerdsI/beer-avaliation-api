...
func (m *MockBeerRepository) ExecInTx(ctx context.Context, fn func(ctx context.Context, txRepo repository.BeerRepository) error) error {
...
func (m *MockModerationRepository) CreateReport(ctx context.Context, report *model.BeerReport) error {
	args := m.Called(ctx, report)
	return args.Error(0)
}

func (m *MockModerationRepository) GetReportsByBeerID(ctx context.Context, beerID string, limit, offset int) ([]model.BeerReport, int, error) {
	args := m.Called(ctx, beerID, limit, offset)
	return args.Get(0).([]model.BeerReport), args.Get(1).(int), args.Error(2)
}

func (m *MockModerationRepository) GetReports(ctx context.Context, filter model.ReportFilter) ([]model.BeerReport, int, error) {
	args := m.Called(ctx, filter)
	return args.Get(0).([]model.BeerReport), args.Get(1).(int), args.Error(2)
}

func (m *MockModerationRepository) ResolveReport(ctx context.Context, reportID, status string, resolvedBy *string, resolvedAt time.Time) error {
	args := m.Called(ctx, reportID, status, resolvedBy, resolvedAt)
	return args.Error(0)
}

func (m *MockModerationRepository) CreateDeletionRequest(ctx context.Context, req *model.BeerDeletionRequest) error {
	args := m.Called(ctx, req)
	return args.Error(0)
}

func (m *MockModerationRepository) GetDeletionRequests(ctx context.Context, filter model.DeletionRequestFilter) ([]model.BeerDeletionRequest, int, error) {
	args := m.Called(ctx, filter)
	return args.Get(0).([]model.BeerDeletionRequest), args.Get(1).(int), args.Error(2)
}

func (m *MockModerationRepository) ResolveDeletionRequest(ctx context.Context, reqID, status string, reviewedBy *string, reviewedAt time.Time) error {
	args := m.Called(ctx, reqID, status, reviewedBy, reviewedAt)
	return args.Error(0)
}

func (m *MockModerationRepository) ExecInTx(ctx context.Context, fn func(ctx context.Context, txRepo repository.ModerationRepository, txBeerRepo repository.BeerRepository) error) error {
	args := m.Called(ctx, fn)
	return args.Error(0)
}
